...
export default function TechnicianDashboard() {
    ...
    const getCategoryName = (categorie) => {
        ...
        // Pass through translation function t() so it translates compound keys like "maintenance informatique"
        return t(rawCat);
    };
            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-3xl border border-blue-100 shadow-xl p-8 space-y-6">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            <h2 className="text-lg font-bold text-gray-900">{t('ticketQueue')}</h2>
                            <p className="text-xs text-gray-400">{t('ticketQueueSubtitle')}</p>
                        </div>
                    </div>
